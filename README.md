...
Stima della topologia di un grafo a partire da segnali osservati sui nodi (graph signal processing). Il progetto confronta un metodo iterativo classico, **PDS** (Primal-Dual Splitting), con una sua versione _Deep Unfolding_ (**Unrolling** e **Recurrent Unrolling**), su due famiglie di grafi sintetici: **Barabási-Albert (BA)** ed **Erdős-Rényi (ER)**.
